...
def hemisphere_data (browser):
    ...
    #return img_url_cerberus, title_cerberus, img_url_schiaparelli, title_schiaparelli, img_url_syrtis_major, title_syrtis_major, img_url_valles_marineris, title_valles_marineris
